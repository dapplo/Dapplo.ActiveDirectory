...
public static class ActiveDirectoryExtensions
{
	...
	{
		domain ??= ActiveDirectoryGlobals.DefaultDomainServerName;
		if (string.IsNullOrEmpty(domain))
		{
			throw new NullReferenceException("Specified domain and ActiveDirectoryGlobals.DefaultDomain are both null.");
		}
		var domainServerPath = string.Format(ActiveDirectoryGlobals.LdapUriFormat, domain);
