...
namespace Dapplo.ActiveDirectory
{
	...
	/// Here is a list of user attributes which should always be available as they are standard: http://www.selfadsi.org/user-attributes.htm
	/// </summary>
	public enum UserProperties
	{
		[EnumMember(Value = "accountExpires")]
		AccountExpires,
